...
def confirmation_score_sample(
    ...
    Returns:
        ...
        scores: Normalized confirmation scores for the samples
    ...
    new_conditions, new_scores = confirmation_score_sample_from_predictions(
        conditions,
        predicted_observations,
        reference_conditions,
        reference_observations,
...
def confirmation_score_sample_from_predictions(
    conditions: Union[pd.DataFrame, np.ndarray],
...
confirmation_pool = pool
confirmation_pool.__doc__ = """Alias for pool"""
confirmation_pooler = deprecated_alias(confirmation_pool, "confirmation_pooler")
